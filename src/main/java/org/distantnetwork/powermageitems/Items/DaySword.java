...
public class DaySword extends WeaponItem {
    public DaySword() {
        super(
                Material.IRON_SWORD,
                1,
                String.format("%sDay Sword", ChatColor.LIGHT_PURPLE),
                Arrays.asList(
                        String.format("%sAbility: Sunlight %sPASSIVE", ChatColor.GOLD, ChatColor.YELLOW),
                        String.format("%sDeals %s33%% %smore damage during the day.", ChatColor.GRAY, ChatColor.GREEN, ChatColor.GRAY)
                ),
